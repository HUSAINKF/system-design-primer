...
* **일관성(Consistency)** - 모든 읽기 연산은 가장 최근에 일어난 쓰기 연산이나 오류를 읽어들입니다.
...
응답은 노드에서 이용할 수 있는 최신 버전의 데이터를 반환합니다. 최신 버전이 아닐 수도 있겠지만요. 분할이 발생하면 쓰기 작업의 전파 시간이 좀 더 오래 걸릴 수도 있습니다.
